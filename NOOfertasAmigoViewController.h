//
//  NOOfertasAmigoViewController.h
//  Noctua
//
...
@interface NOOfertasAmigoViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic) int amigo;
