...
- (void) loadData
{
    ...
    if([aImageUrls count] > 0)
    {
        ...
        for (int i = 0; i < [aImageUrls count]; i++)
        {
            ...
            [imageView setTag:i];
            [imageView sd_setImageWithURL:[NSURL URLWithString:(NSString *)[aImageUrls objectAtIndex:i]]];
...
- (void) initializePageControl
{
    ...
    _pageControl.currentPageIndicatorTintColor = RGB(97, 168, 221);
    _pageControl.pageIndicatorTintColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7f];
