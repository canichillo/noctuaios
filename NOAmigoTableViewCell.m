...
@implementation NOAmigoTableViewCell
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self)
    {
        ...
        self.dispositivo = [[SPLabel alloc] initWithFrame:CGRectMake(74, 18, screenWidth - 100, 20)
                                                     Text:@""
        ...
        // Banda separadora
        UIView * separacion        = [[UIView alloc] initWithFrame:CGRectMake(0, 55, screenWidth, 1)];
